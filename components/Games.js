      ...
      <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {isLoading &&
          skeletons.map((skeleton) => (
            <div
              role="status"
              className="p-4 border w-[300px] m-2 border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
              key={skeleton}
            >
              ...
              <div className="flex items-center mt-4 space-x-3">
                <div className="h-10 bg-gray-200 rounded-md dark:bg-gray-700 w-full mb-2"></div>
              </div>
